...
<li class='start selected'><a href='/asg3/GameConsolesPage.jsp'>Game Consoles</a></li>
...
<article>
<h2>Game Consoles</h2>
<p>Following are the different gaming consoles for sale.</p>
<p>Click on a model to purchase or check the reviews.</p>
</article>
<article class='expanded'>
<h2>Models in gaming consoles</h2>
<table>
...
%> 
				<tr>
				<td>
					<img src = 'images/img_XBoxOne.jpg' width = '200' height = '200' alt = 'X Box Orginal'>
				</td>
				<td>
					<p> Specifications </p>
