...
<li class='start selected'><a href='/asg3/Sony.jsp'>Sony</a></li>
...
<article>
<h2>Sony</h2>
<p>Following are the different models of Sony for sale.</p>
...
%> 
				<tr>
				<td>
					<img src = 'images/img_PlayStation4.jpg' width = '200' height = '200' alt = 'X Box Orginal'>
				</td>
				<td>
					<p> Specifications </p>
