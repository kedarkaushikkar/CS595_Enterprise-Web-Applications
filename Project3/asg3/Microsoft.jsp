...
<li class='start selected'><a href='/asg3/Microsoft.jsp'>Microsoft</a></li>
<li class="end"><a href="/asg3/Logout.jsp">Sign Out</a></li>
</ul>
</nav>
<img class='header-image' src='images/Microsoft.jpg' width = '100%' height = '100%' alt='X Box' />
<div id='body'>
<section id='content'>
<article>
<h2>Microsoft</h2>
<p>Following are the different models of Microsoft for sale.</p>
...
<%
     ...
     ArrayList<ProdDS> listx = new ArrayList<ProdDS>();
      ...
      for(ProdDS element : listx)
        {
            if(element.getProdManfName().equals("Microsoft"))
            {
