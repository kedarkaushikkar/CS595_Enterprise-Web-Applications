...
<li class='start selected'><a href='/asg3/Accessories.jsp'>Accessories</a></li>
...
<article>
<h2>Accessories</h2>
<p>Following are the gaming accessories for sale.</p>
...
%> 
				<tr>
				<td>
					<img src = 'images/gameModel.jpg' width = '200' height = '200' alt = 'X Box Orginal'>
				</td>
				<td>
					<p> Specifications </p>
