...
public class ActServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Games</a></li>"+
                "</ul>"+
                "</nav>"+
        ...
        for(ProdDS element : listx)
        {
            if(element.getProdCat().equals("Games"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<input type = 'hidden' name = 'hiddenProdPrice' value = '"+newPrice+"'>");
                out.println("<input type = 'hidden' name = 'hiddenProdCateg' value = '"+element.getProdCat()+"'>");
                out.println("<input type = 'hidden' name = 'hiddenZip' value = '35152'>");
                out.println("<input type = 'hidden' name = 'hiddenState' value = 'CA'>");
                out.println("<input type = 'hidden' name = 'hiddenCity' value = 'Carson'>");
