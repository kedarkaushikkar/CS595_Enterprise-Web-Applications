...
public class TtiServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Accessories</a></li>"+
                "</ul>"+
                "</nav>"+
                "<img class='header-image' src='images/accessories.jpg' width = '100%' height = '100%' alt='X Box' />"+
                "<div id='body'>"+
                "<section id='content'>"+
                "<article>"+
                "<h2>Accessories</h2>"+
                "<p>Some Gaming Accessories required to hard core gamers.</p>"+
        ...
        {
            if(element.getProdCat().equals("Accessories"))
            {
