...
public class NitendoServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Nitendo</a></li>"+
                "</ul>"+
                "</nav>"+
                "<img class='header-image' src='images/Nitendo.png' width = '100%' height = '100%' alt='X Box' />"+
                "<div id='body'>"+
                "<section id='content'>"+
                "<article>"+
                "<h2>X Box</h2>"+
                "<p>Following are the different models of Nitendo for sale.</p>"+
        ...
        {
            if(element.getProdManfName().equals("Nitendo"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/Nitendo_Prod.jpg' width = '200' height = '200' alt = 'Nitendo'>");
                out.println("</td>");
                out.println("<td>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'NitendoProd' value = 'Add to Cart'>");
                out.println("</form>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'NitendoProd' value = 'Write Review'>");
                out.println("</form>");
                out.println("<form class = 'submit-button' method = 'get' action = '/csj/ViewReviews'>");
                out.println("<input type = 'hidden' name = 'hiddenProdID' value = '"+element.getID()+"'>");
                out.println("<input class = 'submit-button' type = 'submit' name = 'NitendoProd' value = 'View Reviews'>");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
