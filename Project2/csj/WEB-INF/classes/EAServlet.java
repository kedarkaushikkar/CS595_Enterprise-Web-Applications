...
public class EAServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Game Consoles</a></li>"+
                "</ul>"+
                "</nav>"+
                "<img class='header-image' src='images/ea.png' width = '100%' height = '100%' alt='X Box' />"+
                "<div id='body'>"+
                "<section id='content'>"+
                "<article>"+
                "<h2>X Box</h2>"+
                "<p>Gaming Consoles available.</p>"+
        ...
        {
            if(element.getProdCat().equals("Game-Consoles"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/eaprod.png' width = '200' height = '200' alt = 'ea-sports'>");
                out.println("</td>");
                out.println("<td>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'EaProds' value = 'Add to Cart'>");
                out.println("</form>");
                ...
                out.println("<input type = 'hidden' name = 'hiddenProdPrice' value = '"+newPrice+"'>");
                out.println("<input type = 'hidden' name = 'hiddenProdCateg' value = '"+element.getProdCat()+"'>");
                out.println("<input type = 'hidden' name = 'hiddenZip' value = '14616'>");
                out.println("<input type = 'hidden' name = 'hiddenState' value = 'MA'>");
                out.println("<input type = 'hidden' name = 'hiddenCity' value = 'Boston'>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'EaProds' value = 'Write Review'>");
                out.println("</form>");
                out.println("<form class = 'submit-button' method = 'get' action = '/csj/ViewReviews'>");
                out.println("<input type = 'hidden' name = 'hiddenProdID' value = '"+element.getID()+"'>");
                out.println("<input class = 'submit-button' type = 'submit' name = 'EaProds' value = 'View Reviews'>");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
