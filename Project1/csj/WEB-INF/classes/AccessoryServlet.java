...
public class AccessoryServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<article>"+
                "<h2>X Box</h2>"+
                "<p>Following are the different Accessories for sale.</p>"+
        ...
        for(ProdDS element : listx)
        {
            if(element.getProdCat().equals("Accessories"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/gameModel.jpg' width = '200' height = '200' alt = 'Accessories'>");
                out.println("</td>");
                out.println("<td>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'accessories' value = 'Add to Cart'>");
                out.println("</form>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'accessories' value = 'Write Review'>");
                out.println("</form>");
                out.println("<form class = 'submit-button' method = 'get' action = '/csj/ViewReviews'>");
                out.println("<input type = 'hidden' name = 'hiddenProdID' value = '"+element.getID()+"'>");
                out.println("<input class = 'submit-button' type = 'submit' name = 'accessories' value = 'View Reviews'>");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
