...
public class TtiServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Take Two Interactive</a></li>"+
                "</ul>"+
                "</nav>"+
                "<img class='header-image' src='images/ttilogo.jpg' width = '100%' height = '100%' alt='X Box' />"+
                "<div id='body'>"+
                "<section id='content'>"+
                "<article>"+
                "<h2>X Box</h2>"+
                "<p>Take two Interactive Products and Games available.</p>"+
        ...
        {
            if(element.getProdManfName().equals("Take-Two-Interactive"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/ttiprod.jpg' width = '200' height = '200' alt = 'tti'>");
                out.println("</td>");
                out.println("<td>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'ttiProd' value = 'Add to Cart'>");
                out.println("</form>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'ttiProd' value = 'Write Review'>");
                out.println("</form>");
                out.println("<form class = 'submit-button' method = 'get' action = '/csj/ViewReviews'>");
                out.println("<input type = 'hidden' name = 'hiddenProdID' value = '"+element.getID()+"'>");
                out.println("<input class = 'submit-button' type = 'submit' name = 'ttiProd' value = 'View Reviews'>");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
