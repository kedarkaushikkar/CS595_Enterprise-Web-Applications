...
public class WarrantyServlets extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                "<li class='start selected'><a href='#'>Warranty Cards</a></li>"+
                "</ul>"+
                "</nav>"+
                "<img class='header-image' src='images/img_index2.jpg' width = '100%' height = '100%' alt='X Box' />"+
                "<div id='body'>"+
                "<section id='content'>"+
                "<article>"+
                "<h2>X Box</h2>"+
                "<p>Warranty Cards for your products.</p>"+
                "<p>Click on any item to purchase or check the reviews.</p>"+
                "</article>"+
                "<article class='expanded'>"+
                "<h2>Models in Nitendo</h2>"+
                "<table>");
        for(ProdDS element : listx)
        {
            if(element.getProdCat().equals("WarrantyCard"))
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/GameCenterApp.jpg' width = '200' height = '200' alt = 'warranty card'>");
                out.println("</td>");
                out.println("<td>");
                out.println("<p> Specifications </p>");
                out.println("<b>Product Name: </b>"+element.getProdName()+"</br>");
                out.println("<b>Description: </b>"+element.getProdDesc()+"</br>");
                out.println("<b>Manufacturer: </b>"+element.getProdManfName()+"</br>");
                out.println("<b>Price: </b>"+newPrice+"</br>");
                out.println("</td>");
                out.println("<td>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'warranty' value = 'Add to Cart'>");
                out.println("</form>");
                ...
                out.println("<input class = 'submit-button' type = 'submit' name = 'warranty' value = 'Write Review'>");
                out.println("</form>");
                out.println("<form class = 'submit-button' method = 'get' action = '/csj/ViewReviews'>");
                out.println("<input type = 'hidden' name = 'hiddenProdID' value = '"+element.getID()+"'>");
                out.println("<input class = 'submit-button' type = 'submit' name = 'warranty' value = 'View Reviews'>");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
