...
public class SingleProductPage extends HttpServlet {
        ...
        for(ProdDS element : listx)
        {
            if(element.getID() == prodID)
            {
               ...
               // double origPrice = Double.valueOf(originalPrice);
                ...
                out.println("<tr>");
                out.println("<td>");
                out.println("<img src = 'images/GameCenterApp.jpg' width = '200' height = '200' alt = 'Accessories'>");
                out.println("</td>");
                out.println("<td>");
